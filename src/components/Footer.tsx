          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-4 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-4">
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="group relative p-2 rounded-full bg-secondary/50 backdrop-blur-sm border border-silver/10 transition-[background-color,border-color,transform] duration-300 hover:bg-primary/20 hover:border-primary/40 hover:scale-110">
                  <Facebook className="h-4 w-4 text-silver-muted group-hover:text-primary transition-colors duration-300" />
                </a>
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="group relative p-2 rounded-full bg-secondary/50 backdrop-blur-sm border border-silver/10 transition-[background-color,border-color,transform] duration-300 hover:bg-primary/20 hover:border-primary/40 hover:scale-110">
                  <Twitter className="h-4 w-4 text-silver-muted group-hover:text-primary transition-colors duration-300" />
                </a>
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="group relative p-2 rounded-full bg-secondary/50 backdrop-blur-sm border border-silver/10 transition-[background-color,border-color,transform] duration-300 hover:bg-primary/20 hover:border-primary/40 hover:scale-110">
              ...
              <div className="space-y-2">
                <a href="#" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-secondary/50 backdrop-blur-sm border border-silver/10 transition-[background-color,border-color,transform] duration-300 hover:bg-primary/20 hover:border-primary/40 hover:scale-105 group text-sm w-fit">
                  ...
                  <div className="text-left">
                    <div className="text-xs text-silver-muted group-hover:text-silver transition-colors leading-tight">
                      Google Play
                    </div>
                  </div>
                </a>
