...
interface SortableCategoryProps {
  ...
  onDragEnd: (event: DragEndEvent, parentId: string) => void;
}
...
const SortableSubCategory = ({ category, onEdit, onDelete }: SortableSubCategoryProps) => {
  const {
    attributes,
    listeners,
    setNodeRef,
...
export default function CategoriesManagement() {
  ...
  const handleAddSubCategory = useCallback((parentCategory: Category) => {
    setEditingId(null);
  ...
  const handleDragEnd = useCallback(async (event: DragEndEvent, parentId: string | null = null) => {
  ...
  }, [categories, mainCategories, toast]);
