...
export const BOTTOM_NAV_HEIGHT = 44;

/** Extra breathing room between content and nav */
export const BOTTOM_NAV_PADDING_EXTRA = 8;

/** Total bottom offset for main content padding: nav height + extra spacing */
export const BOTTOM_NAV_CONTENT_OFFSET = BOTTOM_NAV_HEIGHT + BOTTOM_NAV_PADDING_EXTRA; // 52
